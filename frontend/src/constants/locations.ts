...
export const LOCATIONS: Location[] = [
  ...
  { id: 'sagrada', name: 'Sagrada Familia', region: 'Europe', country: 'Spain', coords: { lat: 41.4036, lng: 2.1744 }, image: 'https://images.unsplash.com/photo-1583779457186-1c11507d51ab?w=800&q=80', category: 'sacred' },
  ...
  { id: 'alhambra', name: 'Alhambra', region: 'Europe', country: 'Spain', coords: { lat: 37.1760, lng: -3.5881 }, image: 'https://images.unsplash.com/photo-1591122947157-26bad3a117d2?w=800&q=80', category: 'ancient' },
  ...
  { id: 'swiss-alps', name: 'Swiss Alps', region: 'Europe', country: 'Switzerland', coords: { lat: 46.8182, lng: 8.2275 }, image: 'https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=800&q=80', category: 'nature' },
  ...
  { id: 'hagia-sophia', name: 'Hagia Sophia', region: 'Asia', country: 'Turkey', coords: { lat: 41.0086, lng: 28.9802 }, image: 'https://images.unsplash.com/photo-1541432901042-2d8bd64b4a9b?w=800&q=80', category: 'sacred' },
  ...
  { id: 'golden-temple', name: 'Golden Temple', region: 'Asia', country: 'India', coords: { lat: 31.6200, lng: 74.8765 }, image: 'https://images.unsplash.com/photo-1587899897387-091ebd01a8b7?w=800&q=80', category: 'sacred' },
  ...
  { id: 'cappadocia', name: 'Cappadocia', region: 'Asia', country: 'Turkey', coords: { lat: 38.6431, lng: 34.8307 }, image: 'https://images.unsplash.com/photo-1541432901042-2d8bd64b4a9b?w=800&q=80', category: 'wonder' },
  ...
  { id: 'cusco', name: 'Cusco Historic Center', region: 'Americas', country: 'Peru', coords: { lat: -13.5320, lng: -71.9675 }, image: 'https://images.unsplash.com/photo-1526392060635-9d6019884377?w=800&q=80', category: 'urban' },
  ...
  { id: 'abu-simbel', name: 'Abu Simbel', region: 'Africa', country: 'Egypt', coords: { lat: 22.3372, lng: 31.6258 }, image: 'https://images.unsplash.com/photo-1568322445389-f64ac2515020?w=800&q=80', category: 'ancient' },
  { id: 'okavango', name: 'Okavango Delta', region: 'Africa', country: 'Botswana', coords: { lat: -19.2872, lng: 22.8374 }, image: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800&q=80', category: 'nature' },
  { id: 'ngorongoro', name: 'Ngorongoro Crater', region: 'Africa', country: 'Tanzania', coords: { lat: -3.1722, lng: 35.5873 }, image: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800&q=80', category: 'nature' },
  { id: 'valley-kings', name: 'Valley of the Kings', region: 'Africa', country: 'Egypt', coords: { lat: 25.7402, lng: 32.6014 }, image: 'https://images.unsplash.com/photo-1568322445389-f64ac2515020?w=800&q=80', category: 'ancient' },
  { id: 'sossusvlei', name: 'Sossusvlei Dunes', region: 'Africa', country: 'Namibia', coords: { lat: -24.7352, lng: 15.2903 }, image: 'https://images.unsplash.com/photo-1509023464722-18d996393ca8?w=800&q=80', category: 'nature' },
  ...
  { id: 'twelve-apostles', name: 'Twelve Apostles', region: 'Oceania', country: 'Australia', coords: { lat: -38.6659, lng: 143.1051 }, image: 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?w=800&q=80', category: 'nature' },
  ...
  { id: 'harbour-bridge', name: 'Sydney Harbour Bridge', region: 'Oceania', country: 'Australia', coords: { lat: -33.8523, lng: 151.2108 }, image: 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?w=800&q=80', category: 'urban' },
];
